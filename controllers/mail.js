                                                                                                ...
                                                                                                if (alertsError) {
                                                                                                    ...
                                                                                                    customerDoc.find({
                                                                                                        ...
                                                                                                        if (customerError) {
                                                                                                            ...
                                                                                                            if (success[j].IsFirstAlertSent && success[0].IsFirstAlertSent == 0) {
                                                                                                                ...
                                                                                                                readHTMLFile(filePath, function (err, html) {
                                                                                                                    ...
                                                                                                                    var mailOptions = {
                                                                                                                        ...
                                                                                                                        subject: 'CatchLetter Alert: ' + success[0].website_name + ' has sent their first newsletter',
                                                                                                                        html: htmlToSend
                                                                                                                    };
                                                                                                                ...
                                                                                                                if (!success[j].IsFirstAlertSent)

                                                                                                                {
                                                                                                                    console.log("IsFirstAlert not present")
                                                                                                                    const filePath = path.join(__dirname, '..', 'emailTemplates', 'alerts.html');
                                                                                                                    readHTMLFile(filePath, function (err, html) {
                                                                                                                        var template = handlebars.compile(html);
                                                                                                                        var replacements = {
                                                                                                                ...
                                                                                                                {
                                                                                                                    console.log("IsFirst Alert already present");
                                                                                                                    resolve();
                                                                                                                }
